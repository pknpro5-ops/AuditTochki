        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:mail@hot-plan.ru" className="w-8 h-8 flex items-center justify-center rounded-lg bg-[var(--background)] border border-[var(--border)] hover:border-[var(--primary)]/50 hover:text-[var(--primary)] transition-all" aria-label="Email">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--muted-foreground)]">
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0" aria-hidden="true" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                <a href="mailto:mail@hot-plan.ru" className="hover:text-[var(--foreground)] transition-colors">mail@hot-plan.ru</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
              ...
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0" aria-hidden="true" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
                <a href="tel:+74999386615" className="hover:text-[var(--foreground)] transition-colors">+7 (499) 938-66-15</a>
              </li>
              <li className="text-xs mt-2 pt-2 border-t border-[var(--border)]">
                ИП Митин В.Г.<br />
                ИНН: 132102236931<br />
                ОГРНИП: 324508100360362<br />
                г. Москва, ул. Вавилова, 53, корп. 1
              </li>
            </ul>
          </div>
        </div>
